...
1. 사용자가 채팅으로 원하는 스타일을 요청하면
2. AI가 캡션·해시태그를 생성하고, OneDrive에 동기화된 시술 사진 중에서 게시물에 어울리는 사진을 선택하고
3. 검토(수정/승인) 후 인스타그램에 자동 업로드한다.

로그인 시 Microsoft 계정으로 OneDrive 사진을 동기화하고, 온보딩(20문항)으로 브랜드 톤·해시태그 스타일·업로드 스케줄 등을 개인화한다.
