    ...
    >
      <div className="py-2">
        ...
        <div className="flex flex-row justify-between items-center mb-5">
          ...
          <button 
            onClick={() => handleSnsConnection('인스타그램', isInstagramConnected, setIsInstagramConnected, `https://www.instagram.com/oauth/authorize?force_reauth=true&client_id=${process.env.NEXT_PUBLIC_INSTAGRAM_CLIENT_ID}&redirect_uri=https://api2.bybaekofficial.com/api/auth/instagram&response_type=code&scope=instagram_business_basic%2Cinstagram_business_manage_messages%2Cinstagram_business_manage_comments%2Cinstagram_business_content_publish%2Cinstagram_business_manage_insights`)}
